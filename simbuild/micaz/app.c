...
#line 270
      sim_log_debug(165U, "AODVsimulator", "rreply received!hop: %hhu\n", __nesc_ntoh_uint16(rreply->hop.nxdata));
      ...
      for (AODVsimulator$i[sim_node()] = 0; AODVsimulator$i[sim_node()] < 4 && !AODVsimulator$found[sim_node()]; AODVsimulator$i[sim_node()]++) {
          if (__nesc_ntoh_uint16(AODVsimulator$routingTable[sim_node()][AODVsimulator$i[sim_node()]].dest.nxdata) == __nesc_ntoh_uint16(rreply->src.nxdata)) {
              if ((__nesc_ntoh_uint16(AODVsimulator$routingTable[sim_node()][AODVsimulator$i[sim_node()]].num_hop.nxdata) > __nesc_ntoh_uint16(rreply->hop.nxdata) || __nesc_ntoh_uint16(AODVsimulator$routingTable[sim_node()][AODVsimulator$i[sim_node()]].num_hop.nxdata) == 0) || __nesc_ntoh_uint16(AODVsimulator$routingTable[sim_node()][AODVsimulator$i[sim_node()]].status.nxdata) != 2) {
      ...
      for (AODVsimulator$i[sim_node()] = 0; AODVsimulator$i[sim_node()] < 4; AODVsimulator$i[sim_node()]++) {
          if (__nesc_ntoh_uint16(AODVsimulator$cacheTable[sim_node()][AODVsimulator$i[sim_node()]].dest.nxdata) == __nesc_ntoh_uint16(rreply->src.nxdata) && __nesc_ntoh_uint16(AODVsimulator$cacheTable[sim_node()][AODVsimulator$i[sim_node()]].src.nxdata) == __nesc_ntoh_uint16(rreply->dest.nxdata) && __nesc_ntoh_uint16(AODVsimulator$cacheTable[sim_node()][AODVsimulator$i[sim_node()]].id.nxdata) == __nesc_ntoh_uint16(rreply->id.nxdata)) {
              sim_log_debug(166U, "AODVsimulator", "send rreply to %hhu!hop: %hhu\n", __nesc_ntoh_uint16(AODVsimulator$cacheTable[sim_node()][AODVsimulator$i[sim_node()]].src.nxdata), __nesc_ntoh_uint16(rreply->hop.nxdata));
              AODVsimulator$sendRReplyMsg(__nesc_ntoh_uint16(rreply->id.nxdata), __nesc_ntoh_uint16(AODVsimulator$cacheTable[sim_node()][AODVsimulator$i[sim_node()]].sender.nxdata), __nesc_ntoh_uint16(rreply->dest.nxdata), __nesc_ntoh_uint16(rreply->src.nxdata), TOS_NODE_ID, __nesc_ntoh_uint16(rreply->hop.nxdata) + 1);
      ...
      if (__nesc_ntoh_uint16(data->dest.nxdata) != TOS_NODE_ID) {
          ...
          for (AODVsimulator$i[sim_node()] = 0; AODVsimulator$i[sim_node()] < 4 && !AODVsimulator$found[sim_node()]; AODVsimulator$i[sim_node()]++) {
              if (__nesc_ntoh_uint16(AODVsimulator$routingTable[sim_node()][AODVsimulator$i[sim_node()]].dest.nxdata) == __nesc_ntoh_uint16(data->dest.nxdata)) {
                  ...
                  if (__nesc_ntoh_uint16(AODVsimulator$routingTable[sim_node()][AODVsimulator$i[sim_node()]].dest.nxdata) == __nesc_ntoh_uint16(data->dest.nxdata)) {
#line 250
                      sim_log_debug(161U, "AODVsimulator", " next_hop %hhu , %hhu\n", __nesc_ntoh_uint16(AODVsimulator$routingTable[sim_node()][AODVsimulator$i[sim_node()]].dest.nxdata), __nesc_ntoh_uint16(data->dest.nxdata));
                    }
#line 251
                  sim_log_debug(162U, "AODVsimulator", "data packet forwarded from %hhu to next_hop %hhu \n", TOS_NODE_ID, __nesc_ntoh_uint16(AODVsimulator$routingTable[sim_node()][AODVsimulator$i[sim_node()]].next_hop.nxdata));
          ...
          if (!AODVsimulator$found[sim_node()]) {
              sim_log_debug(163U, "AODVsimulator", "Error, data pck stops here\n");
            }
        }
      else {
#line 260
        sim_log_debug(164U, "AODVsimulator", "FINISH data packet from %hhu to %hhu received\n", __nesc_ntoh_uint16(data->src.nxdata), __nesc_ntoh_uint16(data->dest.nxdata));
        }
    }
  return bufPtr;
}
...
#line 190
      if (__nesc_ntoh_uint16(rreq->dest.nxdata) == TOS_NODE_ID) {
          sim_log_debug(156U, "AODVsimulator", "rreq found the dest! sending back rreply\n");
...
#line 206
                  ...
                  for (AODVsimulator$i[sim_node()] = 0; AODVsimulator$i[sim_node()] < 4 && !AODVsimulator$found[sim_node()]; AODVsimulator$i[sim_node()]++) {
                      if (__nesc_ntoh_uint16(AODVsimulator$routingTable[sim_node()][AODVsimulator$i[sim_node()]].dest.nxdata) == __nesc_ntoh_uint16(rreq->dest.nxdata) && __nesc_ntoh_uint16(AODVsimulator$routingTable[sim_node()][AODVsimulator$i[sim_node()]].status.nxdata) == 2) {
                          AODVsimulator$found[sim_node()] = TRUE;
                          sim_log_debug(158U, "AODVsimulator", "route found in my routing table \n");
                        }
                    }
...
#line 78
# 80 "/home/user/tinyos-main/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0x40a22c7c, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0x40a22c7c, addr, msg, len);
#line 80
...
# 100 "/home/user/tinyos-main/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0x40a222e0, message_t * msg, error_t error){
#line 100
  switch (arg_0x40a222e0) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0x40a222e0, msg, error);
#line 100
      break;
#line 100
    }
...
# 83 "/home/user/tinyos-main/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0x40ba4644){
#line 83
  switch (arg_0x40ba4644) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0x40ba4644);
#line 83
      break;
#line 83
    }
...
#line 91
{
  ...
  sim_log_debug(167U, "AMQueue", "AMQueue: request to send from %hhu (%p): passed checks\n", clientId, msg);
  ...
  if (/*AMQueueP.AMQueueImplP*/AMQueueImplP$0$current[sim_node()] >= 3) {
      ...
      sim_log_debug(168U, "AMQueue", "%s: request to send from %hhu (%p): queue empty\n", __FUNCTION__, clientId, msg);
      ...
      if (err != SUCCESS) {
          sim_log_debug(169U, "AMQueue", "%s: underlying send failed.\n", __FUNCTION__);
          /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$current[sim_node()] = 3;
      ...
      sim_log_debug(170U, "AMQueue", "AMQueue: request to send from %hhu (%p): queue not empty\n", clientId, msg);
    }
  return SUCCESS;
}
