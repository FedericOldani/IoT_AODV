...
uint16_t AODVsimulator$id_rreq[1000];

int AODVsimulator$found[1000];
...
#line 103
{
  sim_log_debug(152U, "AODVsimulator", "Received packet of length %hhu.\n", len);
}
...
{
  if (err == SUCCESS) {
    AODVsimulator$MilliTimer$startPeriodic(3000);
    }
  else {
#line 53
...
# 100 "/home/user/tinyos-main/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0x40a150e0, message_t * msg, error_t error){
#line 100
  switch (arg_0x40a150e0) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0x40a150e0, msg, error);
#line 100
      break;
#line 100
    }
...
#line 60
{
  ...
  AODVsimulator$id_rreq[sim_node()]++;
  if (AODVsimulator$locked[sim_node()]) {
      return;
    }
  else {
      radio_data_msg_t *rdm = (radio_data_msg_t *)AODVsimulator$Packet$getPayload(&AODVsimulator$packet[sim_node()], sizeof(radio_data_msg_t ));
...
#line 68
      ...
      sim_log_debug(149U, "AODVsimulator", "AODVsimulator: timer fired, send msg to %hhu at time %s \n", AODVsimulator$random_dest[sim_node()], sim_time_string());
      if (__nesc_ntoh_uint16(rdm->dest.nxdata) != TOS_NODE_ID) {

          AODVsimulator$i[sim_node()] = 0;
          while (AODVsimulator$i[sim_node()] < AODVsimulator$N[sim_node()] && AODVsimulator$routingTable[sim_node()][AODVsimulator$i[sim_node()]][0] != AODVsimulator$random_dest[sim_node()]) 
            AODVsimulator$i[sim_node()]++;

          if (AODVsimulator$i[sim_node()] < AODVsimulator$N[sim_node()] && AODVsimulator$routingTable[sim_node()][AODVsimulator$i[sim_node()]][0] == AODVsimulator$random_dest[sim_node()]) {
            if (AODVsimulator$AMSend$send(AODVsimulator$routingTable[sim_node()][AODVsimulator$i[sim_node()]][1], &AODVsimulator$packet[sim_node()], sizeof(radio_data_msg_t )) == SUCCESS) {
              ...
              {
                route_req_t *rreq = (route_req_t *)AODVsimulator$Packet$getPayload(&AODVsimulator$packet[sim_node()], sizeof(route_req_t ));

#line 89
                if (rreq == (void *)0) {
                    return;
                  }
                __nesc_hton_uint16(rreq->id_msg.nxdata, AODVsimulator$id_rreq[sim_node()]);
                __nesc_hton_uint16(rreq->dest.nxdata, AODVsimulator$random_dest[sim_node()]);
                if (AODVsimulator$AMSend$send(AM_BROADCAST_ADDR, &AODVsimulator$packet[sim_node()], sizeof(route_req_t )) == SUCCESS) {
...
# 83 "/home/user/tinyos-main/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0x40b72cf8){
#line 83
  switch (arg_0x40b72cf8) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0x40b72cf8);
#line 83
      break;
#line 83
    }
...
#line 162
# 80 "/home/user/tinyos-main/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0x40a15a7c, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0x40a15a7c, addr, msg, len);
#line 80
...
#line 38
{
  sim_log_debug(148U, "AODVsimulator", "AODVsimulator: node  started\n");
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  if (!strcmp(varname, "AODVsimulator$id_rreq"))
  {
    *addr = (uintptr_t)&AODVsimulator$id_rreq[__nesc_mote];
    *size = sizeof(AODVsimulator$id_rreq[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  memset((void *)&AODVsimulator$locked[__nesc_mote], 0, sizeof AODVsimulator$locked[__nesc_mote]);
  AODVsimulator$id_rreq[__nesc_mote] = 0;
